...
import { useAddProductMutation, useDeleteProductMutation, useGetProductsQuery } from "../../api/product";
              ...
              return (
                <tr key={elem.id}>
                  ...
                  <td className="flex gap-x-4">
                    ...
                    className="py-1 bg-[#fa6e6e] px-5 rounded-[20px] text-white text-[15px]">
                      delete
                    </button>
                    <button
                            onClick={() => setModal(true)}

                    className="py-1 bg-[#a9e270] px-5 rounded-[20px] text-white text-[15px]">
                      edit
                    </button>
                  </td>
                </tr>
